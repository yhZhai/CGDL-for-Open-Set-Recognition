...
class CONV(nn.Module):
    def __init__(self, in_ch, out_ch, kernel, padding, stride, flat_dim, latent_dim):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(
                in_ch, out_ch, kernel_size=kernel, padding=padding, stride=stride
            ),  # (w-k+2p)/s+1
...
class FCONV(nn.Module):
    def __init__(
        self, in_size, unflat_dim, t_in_ch, t_out_ch, t_kernel, t_padding, t_stride
    ):
...
class LVAE(nn.Module):
    ...
    def lnet(self, x, y_de):
        ...
        qmu5_1 = (mu_up5_1 * prec_up5_1 + mu_dn5_1 * prec_dn5_1) / (
            prec_up5_1 + prec_dn5_1
        )
        ...
        qmu4_2 = (mu_up4_2 * prec_up4_2 + mu_dn4_2 * prec_dn4_2) / (
            prec_up4_2 + prec_dn4_2
        )
        ...
        qmu4_1 = (mu_up4_1 * prec_up4_1 + mu_dn4_1 * prec_dn4_1) / (
            prec_up4_1 + prec_dn4_1
        )
        ...
        qmu3_2 = (mu_up3_2 * prec_up3_2 + mu_dn3_2 * prec_dn3_2) / (
            prec_up3_2 + prec_dn3_2
        )
        ...
        qmu3_1 = (mu_up3_1 * prec_up3_1 + mu_dn3_1 * prec_dn3_1) / (
            prec_up3_1 + prec_dn3_1
        )
        ...
        qmu2_2 = (mu_up2_2 * prec_up2_2 + mu_dn2_2 * prec_dn2_2) / (
            prec_up2_2 + prec_dn2_2
        )
        ...
        qmu2_1 = (mu_up2_1 * prec_up2_1 + mu_dn2_1 * prec_dn2_1) / (
            prec_up2_1 + prec_dn2_1
        )
        ...
        qmu1_2 = (mu_up1_2 * prec_up1_2 + mu_dn1_2 * prec_dn1_2) / (
            prec_up1_2 + prec_dn1_2
        )
        ...
        qmu1_1 = (mu_up1_1 * prec_up1_1 + mu_dn1_1 * prec_dn1_1) / (
            prec_up1_1 + prec_dn1_1
        )
    ...
    def loss(self, x, y, y_de, beta, lamda):
        ...
        pm, pv = (
            torch.zeros(mu_latent.shape).cuda(),
            torch.ones(var_latent.shape).cuda(),
        )
        # print("mu1", mu1)
